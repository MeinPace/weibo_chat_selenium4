...
INDEX_FILE = 'E:/weibo/chat.txt'

HEADER = {
    'User-Agent':
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.5195.102 Safari/537.36 Edg/93.0.961.38',
...
if __name__ == '__main__':
    with open(INDEX_FILE, 'w', encoding='utf8') as f:
        with webdriver.Chrome() as driver:
            ...
            WebDriverWait(
                driver, 1e5
            ).until(lambda d: d.find_elements(By.CLASS_NAME,
            ...
            WebDriverWait(driver,
                          20).until(lambda d: d.find_elements(By.CLASS_NAME,
                              'sessionlist.relative.flex.align-items_c'))

            chats = driver.find_elements(By.CLASS_NAME,
                'sessionlist.relative.flex.align-items_c')

            # 把你要获取的对话放在左侧列表的最上面
            target = chats[0]

            uid = target.find_element(By.CLASS_NAME,
                'name.fff.nowrap.font14').find_elements(By.TAG_NAME,
